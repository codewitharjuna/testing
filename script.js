gconst constants =
{
    'en': {
        ...
        "email-input-gita": {"placeholder": "email or mobile number"},
        "popup.language.label": {"innerHtml": "Select Language"},
        "popup.disclaimer": {"innerHtml": "It is completely optional to provide email or mobile number. By clicking on continue you agree to our <a style='color: white' href='privacy-policy' target='_blank'>privacy policy</a>."},
        "email-submit": {"innerHtml": "continue"},
        "main.title": {"innerHtml": "GitaGPT"},
        "main.subtitle": {"innerHtml": "Unlocking life's mysteries with Krishna, 10,00,000+ answered queries"},
        "query-input-gita": {"placeholder": "Ask Bhagavad Gita a question.."},
    ...
    'hi' : {
        ...
        "email-input-gita": {"placeholder": "ईमेल या मोबाइल नंबर"},
        "popup.language.label": {"innerHtml": "भाषा का चयन करे"},
        "popup.disclaimer": {"innerHtml": "ईमेल या मोबाइल नंबर प्रदान करना पूरी तरह से वैकल्पिक है। ठीक है पर क्लिक करके आप हमारी <a style='color: white' href='privacy-policy' target='_blank'>गोपनीयता नीति</a> से सहमत होंगे।"},
        "email-submit": {"innerHtml": "ठीक है"},
        "main.title": {"innerHtml": "GitaGPT"},
        "main.subtitle": {"innerHtml": "कृष्ण के साथ जीवन के रहस्यों की खोज, 10,00,000+ सवालों के जवाब दिए"},
        "query-input-gita": {"placeholder": "भगवद् गीता से प्रश्न पूछें.."},
    ...
    'as': {
        ...
        "email-input-gita": {"placeholder": "ইমেইল বা মোবাইল নম্বৰ"},
        ...
        "main.title": {"innerHtml": "GitaGPT"},
        "main.subtitle": {"innerHtml": "কৃষ্ণৰ সৈতে জীৱনৰ ৰহস্যসমূহ উন্মোচন কৰি 10,00,000+ প্ৰশ্নৰ উত্তৰ দিলে"},
        "query-input-gita": {"placeholder": "গীতাক এটা প্ৰশ্ন সুধিব.."},
    ...
    'bn': {
        ...
        "email-input-gita": {"placeholder": "ইমেইল বা মোবাইল নম্বর"},
        ...
        "main.title": {"innerHtml": "GitaGPT"},
        "main.subtitle": {"innerHtml": "কৃষ্ণের সাথে জীবনের রহস্য উন্মোচন করা, 10,00,000+ প্রশ্নের উত্তর দেওয়া হয়েছে"},
        "query-input-gita": {"placeholder": "গীতাকে একটা প্রশ্ন কর.."},
    ...
    'gu': {
        ...
        "email-input-gita": {"placeholder": "ઈમેલ અથવા મોબાઈલ નંબર"},
        ...
        "main.title": {"innerHtml": "GitaGPT"},
        "main.subtitle": {"innerHtml": "કૃષ્ણ સાથે જીવનના રહસ્યો ખોલીને, 10,00,000+ પ્રશ્નોના જવાબ આપ્યા"},
        "query-input-gita": {"placeholder": "ગીતાને એક પ્રશ્ન પૂછો.."},
    ...
    'kn': {
        ...
        "email-input-gita": {"placeholder": "ಇಮೇಲ್ ಅಥವಾ ಮೊಬೈಲ್ ಸಂಖ್ಯೆ"},
        ...
        "main.title": {"innerHtml": "GitaGPT"},
        "main.subtitle": {"innerHtml": "ಕೃಷ್ಣನೊಂದಿಗೆ ಜೀವನದ ರಹಸ್ಯಗಳನ್ನು ಅನ್ಲಾಕ್ ಮಾಡಿ, 10,00,000+ ಪ್ರಶ್ನೆಗಳಿಗೆ ಉತ್ತರಿಸಲಾಗಿದೆ"},
        "query-input-gita": {"placeholder": "ಗೀತಾಗೆ ಒಂದು ಪ್ರಶ್ನೆ ಕೇಳಿ.."},
    ...
    'ml': {
        ...
        "email-input-gita": {"placeholder": "ഇമെയിൽ അല്ലെങ്കിൽ മൊബൈൽ നമ്പർ"},
        ...
        "main.title": {"innerHtml": "GitaGPT"},
        "main.subtitle": {"innerHtml": "കൃഷ്ണനൊപ്പം ജീവിതത്തിന്റെ നിഗൂഢതകൾ തുറക്കുന്നു, 10,00,000+ ചോദ്യങ്ങൾക്ക് ഉത്തരം ലഭിച്ചു"},
        "query-input-gita": {"placeholder": "ഗീതയോട് ഒരു ചോദ്യം ചോദിക്കൂ.."},
    ...
    'mr': {
        ...
        "email-input-gita": {"placeholder": "ईमेल किंवा मोबाईल नंबर"},
        ...
        "main.title": {"innerHtml": "GitaGPT"},
        "main.subtitle": {"innerHtml": "कृष्णासह जीवनातील रहस्ये उलगडत, 10,00,000+ प्रश्नांची उत्तरे दिली"},
        "query-input-gita": {"placeholder": "गीताला प्रश्न विचारा.."},
    ...
    'or': {
        ...
        "email-input-gita": {"placeholder": "ଇମେଲ୍ କିମ୍ବା ମୋବାଇଲ୍ ନମ୍ବର |"},
        ...
        "main.title": {"innerHtml": "GitaGPT"},
        "main.subtitle": {"innerHtml": "କୃଷ୍ଣଙ୍କ ସହିତ ଜୀବନର ରହସ୍ୟ ଖୋଲିବା, 10,00,000+ ପ୍ରଶ୍ନର ଉତ୍ତର ଦେଇଥିଲେ |"},
        "query-input-gita": {"placeholder": "ଗୀତାଙ୍କୁ ଏକ ପ୍ରଶ୍ନ ପଚାର .."},
    ...
    'pa': {
        ...
        "email-input-gita": {"placeholder": "ਈਮੇਲ ਜਾਂ ਮੋਬਾਈਲ ਨੰਬਰ"},
        ...
        "main.title": {"innerHtml": "GitaGPT"},
        "main.subtitle": {"innerHtml": "ਕ੍ਰਿਸ਼ਨ ਨਾਲ ਜੀਵਨ ਦੇ ਰਹੱਸਾਂ ਨੂੰ ਖੋਲ੍ਹਣਾ, 10,00,000+ ਸਵਾਲਾਂ ਦੇ ਜਵਾਬ ਦਿੱਤੇ"},
        "query-input-gita": {"placeholder": "ਗੀਤਾ ਨੂੰ ਸਵਾਲ ਪੁੱਛੋ.."},
    ...
    'ta': {
        ...
        "email-input-gita": {"placeholder": "மின்னஞ்சல் அல்லது மொபைல் எண்"},
        ...
        "main.title": {"innerHtml": "GitaGPT"},
        "main.subtitle": {"innerHtml": "கிருஷ்ணாவுடன் வாழ்க்கையின் மர்மங்களைத் திறந்து, 10,00,000+ கேள்விகளுக்குப் பதிலளித்தார்"},
        "query-input-gita": {"placeholder": "கீதாவிடம் ஒரு கேள்வி கேள்.."},
    ...
    'te': {
        ...
        "email-input-gita": {"placeholder": "ఇమెయిల్ లేదా మొబైల్ నంబర్"},
        ...
        "main.title": {"innerHtml": "GitaGPT"},
        "main.subtitle": {"innerHtml": "కృష్ణుడితో జీవిత రహస్యాలను అన్‌లాక్ చేస్తూ, 10,00,000+ ప్రశ్నలకు సమాధానాలు ఇచ్చారు"},
        "query-input-gita": {"placeholder": "గీతను ఒక ప్రశ్న అడగండి.."},
    ...
    'bho': {
        ...
        "email-input-gita": {"placeholder": "ईमेल भा मोबाइल नंबर पर भेजल जाव"},
        ...
        "main.title": {"innerHtml": "GitaGPT"},
        "main.subtitle": {"innerHtml": "कृष्ण के साथ जीवन के रहस्य के ताला खोलत, 10,00,000+ सवाल के जवाब दिहलस"},
        "query-input-gita": {"placeholder": "गीता से एगो सवाल पूछीं.."},
    ...
    'mai': {
        ...
        "email-input-gita": {"placeholder": "ईमेल या मोबाइल नंबर पर"},
        ...
        "main.title": {"innerHtml": "GitaGPT"},
        "main.subtitle": {"innerHtml": "कृष्ण के साथ जीवन के रहस्यों को अनलॉक करते हुए 10,00,000+ सवालों के जवाब |"},
        "query-input-gita": {"placeholder": "गीता स एकटा सवाल पूछू.."},
    ...
    'sa': {
        ...
        "email-input-gita": {"placeholder": "ईमेल अथवा मोबाईल नम्बर"},
        ...
        "main.title": {"innerHtml": "GitaGPT"},
        "main.subtitle": {"innerHtml": "कृष्णेन सह जीवनस्य रहस्यं उद्घाटयन् 10,00,000+ प्रश्नानाम् उत्तरं दत्तवन्तः"},
        "query-input-gita": {"placeholder": "गीताम् एकं प्रश्नं पृच्छतु.."},
    ...
    'ne': {
        ...
        "email-input-gita": {"placeholder": "इमेल वा मोबाइल नम्बर"},
        ...
        "main.title": {"innerHtml": "GitaGPT"},
        "main.subtitle": {"innerHtml": "कृष्णसँग जीवनका रहस्यहरू खोल्दै, 10,00,000+ प्रश्नहरूको जवाफ दिइयो"},
        "query-input-gita": {"placeholder": "गीतालाई प्रश्न सोध्नुहोस्.."},
...
const inputElement = document.getElementById("query-input-gita");
...
const createAdElement = () => {
    ...
    newDiv.innerHTML = '<script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-5257087759971551" ' +
        'crossOrigin="anonymous"></script> <ins className="adsbygoogle" style="display:block" ' +
        'data-ad-format="fluid" data-ad-layout-key="-fb+5w+4e-db+86" data-ad-client="ca-pub-5257087759971551" data-ad-slot="2536381385"></ins>' +
...
const fetchResponseFromGita = async (query) => {
    ...
    chatFeedListElement.appendChild(createAdElement());
    const loadingElement = chatFeedListElement.appendChild(createLoadingResponse());
    const chatFeed = document.getElementById('chat-feed');
    const userEmail = localStorage.getItem("user-email");
    chatFeed.scrollTop = chatFeed.scrollHeight;
...
const closeEmailPopup = () => {
    const userEmail = document.getElementById("email-input-gita");
    if (userEmail.value) {
    ...
    // disable fireworks after 5 seconds
    setTimeout(function() {
        const headerContent = document.getElementById("header-content");
        if (headerContent) {
            headerContent.classList.remove("pyro");
        }
    }, 6250);
}
...
// prefill email
if (email) {
    document.getElementById("email-input-gita").value = email;
}

// don't show email popup if locale selection is present
// already registered
if (locale !== null && localeSelected !== null) {
    document.getElementById("email-modal").classList.remove("show");
    document.getElementById("email-modal").classList.remove("display-block");
